...
set(command "env;CC=;CXX=/usr/bin/c++;./configure;-p;/home/julio/tools/migortho/z3/;-b;build;--staticlib")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/julio/tools/migortho/z3-prefix/src/z3-stamp/z3-configure-out.log")
set(stderr_log "/home/julio/tools/migortho/z3-prefix/src/z3-stamp/z3-configure-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/julio/tools/migortho/z3-prefix/src/z3-stamp/z3-configure-*.log")
  endif()
  ...
  set(msg "z3 configure command succeeded.  See also /home/julio/tools/migortho/z3-prefix/src/z3-stamp/z3-configure-*.log")
  message(STATUS "${msg}")
endif()
